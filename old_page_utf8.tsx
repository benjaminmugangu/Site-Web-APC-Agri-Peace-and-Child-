...
const piliers = [
  {
    title: "Protection",
    desc: "Assurer un environnement s├╗r et protecteur pour les enfants et les personnes vuln├®rables.",
    icon: ShieldCheck,
    color: "#ef4444",
    lightColor: "#fee2e2"
  },
  {
    title: "Agriculture",
    desc: "Promouvoir des techniques durables pour garantir la s├®curit├® alimentaire des m├®nages.",
    icon: Sprout,
    color: "#22c55e",
    lightColor: "#dcfce7"
  },
  {
    title: "Dignit├®",
    desc: "Restaurer l'espoir et le respect de soi ├á travers l'autonomisation et l'acc├¿s aux soins.",
    icon: Heart,
    color: "#3b82f6",
    lightColor: "#dbeafe"
  },
  {
    title: "Paix",
    desc: "B├ótir des ponts entre les communaut├®s pour une coexistence pacifique et durable.",
    icon: Handshake,
    color: "#8b5cf6",
    lightColor: "#ede9fe"
  }
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link href="/projets">
                <Button size="lg" variant="white" className="text-lg px-8 gap-2 w-full sm:w-auto">
                  D├®couvrir nos projets <ChevronRight className="w-4 h-4" />
                </Button>
              </Link>
            </div>
          </FadeIn>
        ...
        <div className="container px-4">
          <FadeIn className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-muted-foreground text-lg">
              Nos actions sont structur├®es autour de quatre axes fondamentaux pour garantir un d├®veloppement durable et ├®quitable.
            </p>
          </FadeIn>
        ...
        <div className="container relative z-10 px-4">
          <StaggerContainer className="flex flex-wrap items-center justify-center gap-12 sm:gap-24 text-white">
            <StaggerItem className="text-center">
              ...
              <div className="text-sm font-medium uppercase tracking-wider text-apc-bgLight/80">B├®n├®ficiaires</div>
            </StaggerItem>
            ...
            <StaggerItem className="text-center">
              ...
              <div className="text-sm font-medium uppercase tracking-wider text-apc-bgLight/80">Projets R├®alis├®s</div>
            </StaggerItem>
            <StaggerItem className="hidden sm:block w-px h-24 bg-white/20" />
            <StaggerItem className="text-center">
        ...
        <section className="py-24 bg-gray-50">
          <div className="container px-4">
            <div className="flex justify-between items-end mb-12">
              <div>
                <h2 className="text-3xl font-bold text-gray-900">Nos Projets R├®cents</h2>
                <p className="text-gray-500 mt-2">D├®couvrez nos derni├¿res actions sur le terrain.</p>
              </div>
                ...
                <Link key={project.id} href={`/projets/${project.slug}`} className="group bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100 hover:shadow-md transition-all">
                  <div className="relative h-48 w-full overflow-hidden bg-gray-100 flex items-center justify-center">
                    {project.mainImage ? (
                      ...
                      <span className="text-4xl opacity-20">­ƒî┐</span>
                    )}
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center justify-between text-xs text-gray-400">
                      ...
                      <span>{project.beneficiaries} b├®n├®ficiaires</span>
                    </div>
                  </div>
                </Link>
              ))}
        ...
        <section className="py-20 bg-apc-bgLight border-t border-gray-100">
          <div className="container px-4">
            <FadeIn className="text-center mb-12">
              ...
              <p className="text-muted-foreground mt-3 max-w-2xl mx-auto">D├®couvrez les organisations et institutions qui accompagnent nos actions sur le terrain.</p>
            </FadeIn>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <FadeIn direction="left">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6 leading-tight">
                Chaque action compte dans la <span className="text-apc-green">reconstruction</span> de notre communaut├®.
              </h2>
              <p className="text-muted-foreground text-lg mb-8 leading-relaxed">
                Depuis notre cr├®ation, nous avons constat├® que l&apos;engagement local coupl├® au soutien
                international cr├®e une force imparable. En nous soutenant, vous ne donnez pas seulement,
                vous investissez dans l&apos;autonomie et la dignit├® de milliers de familles.
              </p>
              ...
              <ul className="space-y-4 mb-10">
                ...
                <li className="flex items-center gap-3">
                  ...
                  <span className="text-foreground font-medium">Impact direct sur le terrain (sans interm├®diaire)</span>
                </li>
                <li className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-full bg-apc-blue/10 flex items-center justify-center shrink-0">
                    <CheckCircle2 className="w-5 h-5 text-apc-blue" />
                  </div>
                  <span className="text-foreground font-medium">Projets ancr├®s dans les r├®alit├®s locales</span>
                </li>
              </ul>
