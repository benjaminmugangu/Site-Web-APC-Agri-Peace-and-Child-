...
const menuItems = [
  ...
  { icon: ShieldCheck, label: "Partenaires", href: "/admin/partenaires", roles: ['ADMIN'] },
  { icon: Tag, label: "Types Partenaires", href: "/admin/partenaires/categories", roles: ['ADMIN'], subItem: true },
